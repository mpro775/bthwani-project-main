...
export default class UpdateDonorDto {
  @ApiPropertyOptional({ description: 'فصيلة الدم', example: 'O+', enum: BLOOD_TYPES })
  @IsOptional()
  @IsString()
  @IsIn(BLOOD_TYPES)
  bloodType?: string;
  ...
  @ApiPropertyOptional({ description: 'متاح للتبرع الآن' })
  @IsOptional()
  @IsBoolean()
  available?: boolean;
