...
// التحقق من بيئة التنفيذ - منع تحميل expo-notifications في Expo Go
...
if (!isExpoGo) {
  try {
    ...
    // Silent fail - المكتبة غير متوفرة
  }
} else {
  // في Expo Go - لا نحاول تحميل المكتبة لتجنب التحذيرات
  console.log("Running in Expo Go - Push notifications disabled to avoid warnings.");
}
...
export function attachNotificationListeners(
  ...
  if (!Notifications) {
    return { responseSub: null, receiveSub: null };
  }
