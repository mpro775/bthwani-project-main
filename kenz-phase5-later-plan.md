...
- [ ] **الباك اند:** حقل `acceptsEscrow` في كنز؛ إنشاء وحدة/جدول صفقات (KenzDeal)؛ تكامل hold/release مع المحفظة؛ endpoints إنشاء صفقة، تأكيد استلام، إلغاء
- [ ] **لوحة التحكم:** (اختياري) صفحة صفقات كنز
- [ ] **الويب:** زر شراء بالإيكرو + صفحة/تبويب "صفقاتي"
- [ ] **التطبيق:** نفس المنطق
