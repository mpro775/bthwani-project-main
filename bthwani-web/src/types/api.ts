...
export const ErrorCode = {
  ...
  METHOD_NOT_ALLOWED: 'METHOD_NOT_ALLOWED' as ErrorCode,
  NOT_ACCEPTABLE: 'NOT_ACCEPTABLE' as ErrorCode,
  REQUEST_TIMEOUT: 'REQUEST_TIMEOUT' as ErrorCode,
  CONFLICT: 'CONFLICT' as ErrorCode,
  GONE: 'GONE' as ErrorCode,
  PAYLOAD_TOO_LARGE: 'PAYLOAD_TOO_LARGE' as ErrorCode,
  UNSUPPORTED_MEDIA_TYPE: 'UNSUPPORTED_MEDIA_TYPE' as ErrorCode,
  VALIDATION_ERROR: 'VALIDATION_ERROR' as ErrorCode,
  LOCKED: 'LOCKED' as ErrorCode,
  TOO_MANY_REQUESTS: 'TOO_MANY_REQUESTS' as ErrorCode,
  INTERNAL_ERROR: 'INTERNAL_ERROR' as ErrorCode,
  NOT_IMPLEMENTED: 'NOT_IMPLEMENTED' as ErrorCode,
  BAD_GATEWAY: 'BAD_GATEWAY' as ErrorCode,
  SERVICE_UNAVAILABLE: 'SERVICE_UNAVAILABLE' as ErrorCode,
  GATEWAY_TIMEOUT: 'GATEWAY_TIMEOUT' as ErrorCode,
...
} as Record<ErrorCode, { title: string; message: string; action: string }>;
